...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/box_intersect
  DEFINES   += -DDEBUG
...
$(OBJDIR)/color.o: src/gKit/color.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/box.o: box-intersection-etu/box.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/main.o: box-intersection-etu/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
